...
public class BritishTimeConverter {
  ...
  public BritishTimeConverter(final TimeParser timeParser, final SpeechConverter speechConverter) {
    this.timeParser = timeParser;
    this.speechConverter = speechConverter;
  }

  /** Facade method that orchestrates the entire conversion process */
  public String convert(final String timeInput) {
    ...
    try {
      ...
      throw new IllegalArgumentException(
          String.format("Invalid time format: %s. Expected format: HH:mm or H:mm", timeInput), e);
    }
  }
}
