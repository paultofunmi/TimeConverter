...
/**
 * Concrete strategy implementing flexible time parsing.
 * Handles both H:mm and HH:mm formats.
 */
public class FlexibleTimeParser implements TimeParser {

    private static final DateTimeFormatter FLEXIBLE_FORMATTER = DateTimeFormatter.ofPattern("[H:mm][HH:mm]");
    ...
    private boolean isValidFormat(String timeString) {
        if(timeString == null) throw new IllegalArgumentException("Time input cannot be null or empty");
